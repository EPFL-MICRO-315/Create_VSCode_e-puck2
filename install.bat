...
echo.
color %red%
echo "Be extremely cautious when specifying installation paths, there are risk of damaging your installation "
echo "For instance, do not directly install VSCode EPuck 2 under root C:/"
echo.
color %purple%
echo "Proceed with the installation ?"
set /p ans0="Enter y or Y for Yes and any for No: "
